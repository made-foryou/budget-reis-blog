  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      ...
      <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div class="{{ $loop->first ? '' : 'mt-10 md:mt-0' }}">
    ...
    <div class="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
      <div class="flex space-x-6 md:order-2">
        ...
        @if (nova_get_setting('social_instagram'))
        <a href="{{ nova_get_setting('social_instagram') }}"
      ...
      <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy; {{ date('Y') }} Made for you. All rights reserved.</p>
    </div>
  </div>
</footer>
