...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <header class="bg-white w-screen fixed top-0 left-0 z-50 shadow">
            <nav class="relative isolate mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      -->
                    ...
                    <a href="#" class="text-sm font-semibold leading-6 text-slate-900 hover:text-teal-500 transition-colors duration-100 ease-in-out">Company</a>
                </div>
            </nav>
