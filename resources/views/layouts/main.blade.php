                        ...
                        <div data-flyout>
                            <div class="bg-white py-5">
                                <div class="mx-auto max-w-7xl">
                                    <a data-trigger href="{{ ($category->categories->isEmpty() ? $category->route->route : '#') }}" class="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" aria-expanded="false">
                                        {{ $category->name }}
                            ...
                            <div data-menu class="absolute inset-x-0 top-0 -z-10 bg-white pt-16 shadow-lg ring-1 ring-gray-900/5 opacity-0 -translate-y-1 transition ease-out duration-200">
                                <div class="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-6 py-10 lg:grid-cols-2 lg:px-8">
                                    <div class="grid grid-cols-2 gap-x-6 sm:gap-x-8">
                                        @if ($category->categories->isNotEmpty())
                                        <div>
                                            <h3 class="text-sm font-medium leading-6 text-gray-500">Onderwerpen</h3>
...
{{--                                    </div>--}}
                    ...
                    @endforeach
                    <a href="#" class="text-sm py-5 font-semibold leading-6 text-slate-900 hover:text-teal-500 transition-colors duration-100 ease-in-out">Product</a>
                    <a href="#" class="text-sm py-5 font-semibold leading-6 text-slate-900 hover:text-teal-500 transition-colors duration-100 ease-in-out">Features</a>
                    <a href="#" class="text-sm py-5 font-semibold leading-6 text-slate-900 hover:text-teal-500 transition-colors duration-100 ease-in-out">Marketplace</a>
                    <a href="#" class="text-sm py-5 font-semibold leading-6 text-slate-900 hover:text-teal-500 transition-colors duration-100 ease-in-out">Company</a>
                </div>
            </nav>
